...
inquiry_options() {
  ...
  printf "\n\n"
  printf "   [0] Instalar [CriaTicket]\n"
  printf "   [1] Atualizar [CriaTicket]\n"
  printf "   [2] Deletar [CriaTicket]\n"
  printf "   [3] Bloquear [CriaTicket]\n"
  printf "   [4] Desbloquear [CriaTicket]\n"
  printf "   [5] Alter. dominio [CriaTicket]\n"
  printf "\n"
  read -p "> " option
